...
if __name__ == "__main__":
    ...
    import_so("blockchain_nocode", 54290362)  # no code!
    # https://stackoverflow.com/questions/13137817/
    #how-to-download-image-using-requests
    import_so("requests_help", 13137817)  # requests, excellent example
    import_so("idenitfy_py2", 38604451)  # has negative answer
    # https://stackoverflow.com/questions/151199/
    #how-to-calculate-number-of-days-between-two-given-dates
    import_so("days_between", 151199)  # has interactive e.g. >>>
    # https://stackoverflow.com/questions/7586063/
    #how-to-calculate-the-angle-between-a-line-and-the-horizontal-axis
    import_so("angle_calc", 7586063)
    # https://stackoverflow.com/questions/31684375/
    #automatically-create-requirements-txt
    import_so("requirements_from_text", 31684375)
