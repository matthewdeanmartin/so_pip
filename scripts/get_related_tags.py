...
from so_pip.api_clients.stackapi_facade import get_json_related_tags
...
if __name__ == "__main__":
    ...
    for language in FILE_EXTENSIONS:
        value = get_json_related_tags(language)
        found = [_["name"] for _ in value["items"]]
        related_tags[language] = found
    print(related_tags)
